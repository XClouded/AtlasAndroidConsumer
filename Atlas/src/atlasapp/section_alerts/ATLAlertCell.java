...
public class ATLAlertCell extends RelativeLayout implements View.OnClickListener {
	...
	AlertCellData mCellData;
	boolean isSimulateMode = true;

	public ATLAlertCell(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
		initView(context);
	}

	public ATLAlertCell(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	...
	public ATLAlertCell(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView(context);
	}
...
//						AlertRequestEventSingleton.getInstance().setData(mCellData);
						AlertRequestEventSingleton.getInstance().loadEventPropertiesByKey(mCellData.getEventPrimaryKey());
	...
	public void setCellData(AlertCellData cellData) {
		...
		//===========================================
		if (cellData.alertCellModifiedDate != null) {
			// Nghia Comment out to change better date time converter
//			String time1 = (String) DateUtils.getRelativeDateTimeString(mActivity,
//					mCellData.alertCellModifiedDate.getTime(), DateUtils.DAY_IN_MILLIS,
//					DateUtils.WEEK_IN_MILLIS, DateUtils.FORMAT_SHOW_WEEKDAY);
			String humanizedTime = ATLHumanizedTime.toStringWithHumanizedTimeDiffrence(mCellData.alertCellModifiedDate);
		...
		switch (cellData.currentType) {
		    ...
		    case AlertType.eventRejected_Sent:
		    case AlertType.eventRejected_Received:
		    	alertTypeImageView.setImageResource(R.drawable.alerts_tag_notification_calendar);
		      break;
		    case AlertType.taskAssigned_Sent:
		    case AlertType.taskAssigned_Received:
		    case AlertType.taskAccepted_Sent:
...
//		alertEventTitle.setText(cellData.alertCellEventTitle);
		alertEventTitle.setText(buildTitle(cellData), BufferType.SPANNABLE);
//		if(cellData.alertCellSenderName != null){
//			alertInviterName.setText(cellData.alertCellSenderName);
//		}
//		else{
//			alertInviterName.setText("");
//		}
		//===========================================
	...
	private CharSequence buildTitle(AlertCellData cellData) {
		// TODO Auto-generated method stub
		switch (cellData.currentType) {
	    case AlertType.eventInvited_Sent:{
