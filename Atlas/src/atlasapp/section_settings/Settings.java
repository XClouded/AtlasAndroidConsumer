...
//            	//intent.putExtra("EXTRA_SESSION_ID", sessionId);
         ...
         signOutBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intentCalendar = new Intent(getBaseContext(), ATLWelcome.class);
