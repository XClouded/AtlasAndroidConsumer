...
//	
	...
	public static String userDefaultProfilePictureParseURL = "http://getatlas.com/emails/img/avatar.png";
	public static String kImageUrl = "http://getatlas.com/emails/img/";
	public enum ATL_ENVIRONMENT { 
		QA("qa"), DEV("dev"), DEMO("demo"),
		BETA("beta"), ATLAS("www"), ANDROID("www");

		private final String environment;  

		private ATL_ENVIRONMENT(String environment) 
		{    
	...
	public enum ATL_EMAIL_SUBJECT_TITLE {
		
		WELCOME("Welcome to Atlas"), EMAIL_VERIFY("Please verify Your email address"),
		EVENT_INVITE(" has invited you to ");

		private final String subject;  

		private ATL_EMAIL_SUBJECT_TITLE(String subject) 
		{    
