	...
	public void getEmailAddressRecord(String email) 
	{
		if (email!=null && !email.equals(""))
		{
			...
			emailTableQuery.findInBackground(new FindCallback() {
					  public void done(List<ParseObject> emailRecordFound, ParseException e) {
					    if (e == null && emailRecordFound!=null
					    		&& emailRecordFound.size()>0) 
					    {
					    	
					        // The query was successful.
					    	emailAddressListener.getEmailAddressRecordCallBack(EmailAddressRecord.fromParseObject(emailRecordFound.get(0)));
