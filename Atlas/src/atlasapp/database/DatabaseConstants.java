...
public class DatabaseConstants {
	...
	public static enum USER_INFO { USER_NAME,  PASSWORD, EMAIL, OTHER, PASSWORD_RESET }
	...
	public static enum EVENT_STATUS {PENDING, THE_ONE, NOT_THE_ONE,COMPLITED}
	...
	public static enum ITEM_TYPE_PRIORITY_ORDER {DECLINED,OK,IDEAL}
	...
	public static enum OPERATION_METHOD { 
		...
		FIND_ALL_FACEBOOK_USERS_FRIENDS("find_all_facebook_users_friends"), FIND_ALL_USERS("find_all_users"), FIND_COMMON("find_common"), UPDATE("update"), SAVE_ITEM_USER("save_item_user"), UPDATE_OBJECT_ID("update_object_id"), SIGN_IN_NEW("sign_in_new"), UPDATE_USER("update_user");
	...
	public enum TABLES_NAME {
		...
		EMAIL_ADDRESS("email_address"), OUTBOUND_EMAIL("outbound_email") ;
