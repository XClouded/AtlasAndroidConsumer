...
//  ==================================================================================================================
//  2012-10-28 TAN:    Init class - get from an open source code 
//					   Change Class name to as ATL rule 
//  ==================================================================================================================
...
public abstract class ATLMultiSectionAdapter extends BaseAdapter implements SectionIndexer, OnScrollListener {
	public static final String TAG = ATLMultiSectionAdapter.class.getSimpleName();
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		if (view instanceof ATLMultiSectionListView) {
			((ATLMultiSectionListView) view).configureHeaderView(firstVisibleItem);
		}
	}
	 ...
	 * and call {@link ATLMultiSectionListView#tellNoMoreData()} if there is no more pages.
	 * 
