...
import atlasapp.section_calendar.ATLCalendarActivity;
import atlasapp.section_notes.ATLNoteListActivity;
import atlasapp.section_tasks.ATLTasksActivity;
import atlasapp.section_today.ATLTodayActivity;
...
//				.setContent(new Intent(this, ATLSettingsActivity.class)));
		tabHost.addTab(tabHost.newTabSpec("Settings").setIndicator("Settings")
				.setContent(new Intent(this, ATLWelcome.class)));
