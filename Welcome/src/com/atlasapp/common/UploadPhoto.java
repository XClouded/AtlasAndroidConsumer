...
public class UploadPhoto extends Dialog {
    ...
    public UploadPhoto(Activity activity, String title, String response) {
        super(activity);
            ...
            mViewPhotoButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (hidePhoto) {
                        ...
                        dialog.show();
                        FacebookUtilities.mAsyncRunner.request(photo_id, params,
...
//    public void setTag() {
//        String relativePath = photo_id + "/tags/" + FacebookUtilities.userUID;
//        Bundle params = new Bundle();
//        params.putString("x", "5");
//        params.putString("y", "5");
//        FacebookUtilities.mAsyncRunner.request(relativePath, params, "POST", new TagPhotoRequestListener(),
//                null);
//    }
...
//    }
    ...
    private class FetchImage extends AsyncTask<String, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(String... urls) {
            return FacebookUtilities.getBitmap(urls[0]);
        }
