...
public class ATLCalCellData implements Parcelable {
	...
	// PROPERTIES
	public int eventResponseType_CellData = EventResponseType.eventResponseType_None;

	// Cell Attendee
	public ATLContactModel attendee;
	...
	public ATLCalCellData() {
		...
		this.attendee = new ATLContactModel();
	}
	...
	public void setEventResponseType_CellData(
			int eventResponseType_CellData) {
		this.eventResponseType_CellData = eventResponseType_CellData;
	}

	public ATLContactModel getAttendee() {
		return attendee;
	}

	public void setAttendee(ATLContactModel attendee) {
