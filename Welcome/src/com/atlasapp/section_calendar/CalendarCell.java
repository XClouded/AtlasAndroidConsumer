...
public class CalendarCell extends RelativeLayout implements
	...
	ViewGroup mainView;
	public CalendarCellDelegateInterface calendarDayView;
	public int index = -1;
	public boolean isShowOffHour = false;

	ImageButton moveEventBtn;
	...
	private void initView(Context context) {
		...
		moveEventBtn = (ImageButton) findViewById(R.id.cal_cell_btn_move);
		moveEventBtn.setVisibility(View.GONE);
		moveEventBtn.setOnClickListener(this);
		deleteEventBtn = (ImageButton) findViewById(R.id.cal_cell_btn_delete);
	...
	public void setCellData(ATLCalCellData cellData, int position) {
		// TODO Auto-generated method stub
