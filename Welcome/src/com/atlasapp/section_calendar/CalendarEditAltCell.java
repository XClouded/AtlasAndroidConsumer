...
interface CalendarEditAltCellInterface {
...
public class CalendarEditAltCell extends RelativeLayout implements
	...
	protected CalendarEditAltCellInterface delegate;
	...
	public CalendarEditAltCell(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
		initView(context);
	}

	public CalendarEditAltCell(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		initView(context);
	}

	public CalendarEditAltCell(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		delegate = (CalendarEditAltCellInterface) context;
	}
