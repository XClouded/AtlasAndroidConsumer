...
public class ATLAlertCellList {
	...
	public boolean load() {
		...
		if (this.alertListSimulate) {
			...
			ArrayList<ATLAlertModel> list = dbHelper.loadAllAlertInDatabase();
		...
		Collections.sort(newAlertListArray, new ATLAlertCellDataComparator());
		Collections.sort(pastAlertListArray, new ATLAlertCellDataComparator());
