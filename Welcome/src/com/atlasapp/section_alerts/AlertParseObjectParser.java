...
import com.atlasapp.common.ATLConstants.event_respondData;
...
//				}
		...
		case AlertType.taskAssigned_Received: {
			...
			for (final ParseObject parseObject : parseObjectList) {
				final AlertCellData alertCellData = new AlertCellData();
				alertCellData.alertCellRecieverId = AtlasAndroidUser
						.getParseUserID();
				alertCellData.alertCellReceiverEmail = AtlasAndroidUser
						.getEmail();
				alertCellData.alertCellRecieverName = AtlasAndroidUser
						.getUserNameDisplay();
		...
		case AlertType.taskAccepted_Received: {
			...
			for (final ParseObject parseObject : parseObjectList) {
				...
				alertCellData.alertCellSenderId = AtlasAndroidUser
						.getParseUserID();
				alertCellData.alertCellSenderEmail = AtlasAndroidUser
						.getEmail();
				alertCellData.alertCellSenderName = AtlasAndroidUser
						.getUserNameDisplay();
