//  ==================================================================================================================
//  ATLAlertTaskRequestCellList.java
//  ATLAS
...
import com.atlasapp.section_tasks.ATLTaskSortSingleton;
import com.atlasapp.section_tasks.TaskDatabaseAdapter;
import com.atlasapp.section_tasks.Tasks;
import com.atlasapp.section_tasks.ATLTaskCellList.ATLCalendarModelComparator;
import com.atlasapp.section_tasks.ATLTaskCellList.ATLTaskCellDataComparator;
import com.atlasapp.section_tasks.ATLTaskCellList.IgnoreStringCaseComparator;

/**
 * @author Ryan Tan
 * 
 */
public class ATLAlertTaskRequestCellList {
	...
	public ArrayList<AlertCellData> taskAlertHighListArray = new ArrayList<AlertCellData>();
	public ArrayList<AlertCellData> taskAlertMediumListArray = new ArrayList<AlertCellData>();
	public ArrayList<AlertCellData> taskAlertLowListArray = new ArrayList<AlertCellData>();
	...
	public ATLAlertTaskRequestCellList(String senderID) {
	...
	public boolean load() {
		...
		if (this.alertListSimulate) {
			...
			/*
			 * comment out, just support one task now ATLAlertDatabaseAdapter
			 * dbHelper = new ATLAlertDatabaseAdapter();
			...
			ATLAlertModel alertModel = dbHelper
					.loadATLAlertModelByAlertAtlasId(senderId);
			if(alertModel != null){
				alertListArray.add(new AlertCellData(alertModel));
			}
		}
//		alertListArray.addAll(taskAlertHighListArray);
//		alertListArray.addAll(taskAlertMediumListArray);
//		alertListArray.addAll(taskAlertLowListArray);
		alertListCount = alertListArray.size();
		return true;
	}
	...
	public void removeCell(AlertCellData cellData) {
		switch (cellData.alertCellTaskPriority) {
		case ATLTaskPriorityScrollListAdapter.TASK_PRIORITY_INDEX_HIGH:
			this.taskAlertHighListArray.remove(cellData);
			break;
		case ATLTaskPriorityScrollListAdapter.TASK_PRIORITY_INDEX_MEDIUM:
			this.taskAlertMediumListArray.remove(cellData);
			break;
		case ATLTaskPriorityScrollListAdapter.TASK_PRIORITY_INDEX_LOW:
			this.taskAlertLowListArray.remove(cellData);
			break;

		}

		this.alertListArray.remove(cellData);
	}
