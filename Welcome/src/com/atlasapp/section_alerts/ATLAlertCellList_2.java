...
import com.atlasapp.section_alerts.ATLAlertCellList.ATLAlertCellDataComparator;
...
public class ATLAlertCellList_2 {
	...
	public ATLAlertCellList_2(ArrayList<ATLAlert> alertList) {
		// TODO Auto-generated constructor stub
		// SIMULATION: TURN OFF WHEN REAL DATA IS AVAILABLE
		// ==================================<<<<<<
		// WHEN ON, FAKE CELL DATA WILL BE CREATED
...
//			alertListCount = yourmoveList.size();
